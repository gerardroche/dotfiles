...
alias cpuinfo='lscpu'
alias d='git diff'
alias da='composer -vvv dump-autoload'
alias e='vi'
...
alias eldehosts='vi -o $PROJECTS_PATH/lde/lde/etc/hosts_* $PROJECTS_PATH/.lde/etc/hosts'
alias eldemysql='vi $PROJECTS_PATH/lde/lde/etc/mysql/conf.d/*.ini'
alias eldephp='vi $PROJECTS_PATH/lde/lde/etc/php5/conf.d/*.ini'
alias ephpini='sudo vi -o /etc/php5/*/php.ini'
